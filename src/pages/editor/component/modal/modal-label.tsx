...
export const ModalLabel =
  ...
  ({ hotspot, coordinateX, coordinateY, forceRenderPanorana, onClose }: Props) => {
      ...
      updateHostpot({
      ...
      },
        {
          onSuccess: () => {
            ...
            //     host.id === hotspot.id ? { ...host, text: information } : host
            //   )
            // })
    ...
    const handleDeleteHotspot = () => {
      ...
      const ask = confirm('Yakin ingin menghapus label ini ?')
      ...
      if (ask) {
        deleteHotspot(
          ...
          },
          {
            onSuccess: () => {
              onClose()
              successToaster({ message: 'Berhasil menghapus label' })
              forceRenderPanorana()
            },
            onError: () => {
              errorToaster({ message: 'Gagal menghapus label' })
            }
          }
        )
      }
        ...
        >
          <div>
            <div className='flex flex-col gap-1'>
              <label htmlFor="information-text" className='font-medium'>Label text</label>
              <input
                id='information-text'
                type="text"
